...
const T = {
  en: {
    ...
    home: {
      ...
      journey_label: '00 — embedded systems track',
      journey_title: 'How I Became an Embedded Systems Engineer',
      journey_desc: 'Step by step, project by project: from a rocket motor test bench built for my MSc thesis, to an industrial PCB fabricated for Jaguar de México, to vehicle CAN bus telematics and satellite ground stations.',
      journey_cta: 'View full project',
      journey_items: [
        {
          step: 'STEP 01 · MSc THESIS',
          title: 'Rocket Motor Test Bench',
          desc: 'CAD + FEA structure, in-house welding, distributed ESP32 DAQ (thrust, pressure, temperature), and a real-time monitoring app. Dedicated schematic & PCB in progress.',
        },
        {
          step: 'STEP 02 · INDUSTRY',
          title: 'Jaguar MX — Thermal Control',
          desc: 'Safety FSM on RP2350, dual-NTC sensing, 48 V power stage, mixed-signal KiCad PCB with 0 DRC errors — fabricated and brought up as SE_TELCODEN_V1.',
        },
        {
          step: 'STEP 03 · AUTOMOTIVE',
          title: 'CAN Bus Fleet Telematics',
          desc: 'OBD-II gateway on the 500 kbit/s CAN bus: PID polling, DTC readout, 4G/MQTT uplink with GPS, and predictive-maintenance alerts for fleets.',
        },
        {
          step: 'STEP 04 · AEROSPACE',
          title: 'CubeSat Ground Station',
          desc: 'Fork of an open-source ground station: SDR reception, TLE pass tracking, AX.25 telemetry decoding, and remote access for national educational CubeSats.',
        },
      ],
    ...
    about: {
      ...
      subtitle: 'Embedded Systems Engineer — Firmware, Hardware & Instrumentation (IPN)',
    ...
    common: {
      overview: '// overview',
      process: '// development process — step by step',
  ...
  es: {
    ...
    home: {
      ...
      journey_label: '00 — trayectoria en sistemas embebidos',
      journey_title: 'Cómo me formé como Ingeniero en Sistemas Embebidos',
      journey_desc: 'Paso a paso, proyecto a proyecto: de un banco de pruebas de motores cohete construido para mi tesis de maestría, a una PCB industrial fabricada para Jaguar de México, a telemática vehicular CAN bus y estaciones terrenas satelitales.',
      journey_cta: 'Ver proyecto completo',
      journey_items: [
        {
          step: 'PASO 01 · TESIS DE MAESTRÍA',
          title: 'Banco de Pruebas de Motores Cohete',
          desc: 'Estructura CAD + FEA, soldadura propia, DAQ distribuido con ESP32 (empuje, presión, temperatura) y app de monitoreo en tiempo real. Esquemático y PCB dedicados en desarrollo.',
        },
        {
          step: 'PASO 02 · INDUSTRIA',
          title: 'Jaguar MX — Control Térmico',
          desc: 'FSM de seguridad en RP2350, sensado dual NTC, etapa de potencia de 48 V, PCB mixed-signal en KiCad con 0 errores DRC — fabricada y puesta en marcha como SE_TELCODEN_V1.',
        },
        {
          step: 'PASO 03 · AUTOMOTRIZ',
          title: 'Telemática Vehicular CAN Bus',
          desc: 'Gateway OBD-II sobre el bus CAN a 500 kbit/s: consulta de PIDs, lectura de DTCs, enlace 4G/MQTT con GPS y alertas de mantenimiento predictivo para flotas.',
        },
        {
          step: 'PASO 04 · AEROESPACIAL',
          title: 'Estación Terrena para CubeSats',
          desc: 'Fork de una estación terrena open-source: recepción SDR, rastreo de pases por TLE, decodificación de telemetría AX.25 y acceso remoto para CubeSats educativos nacionales.',
        },
      ],
    ...
    about: {
      ...
      subtitle: 'Ingeniero en Sistemas Embebidos — Firmware, Hardware e Instrumentación (IPN)',
    ...
    common: {
      ...
      process: '// proceso de desarrollo — paso a paso',
