        ...
        <div className="px-6 py-5 flex flex-col gap-1">
          {NAV_LINKS.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className={`text-base py-3 px-2 border-b border-border-subtle last:border-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded ${
          ...
          <div className="flex items-center gap-3 pt-4 mt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 text-center py-2.5 border border-border text-sm text-accent font-mono rounded hover:border-accent transition-colors"
            >
              {t.nav.cv} ↗
            </a>
            <button
              onClick={toggleLang}
              className="px-4 py-2.5 font-mono text-sm border border-border rounded text-text-secondary hover:border-accent hover:text-accent transition-colors"
            >
              {lang === 'en' ? 'ES' : 'EN'}
            </button>
            <button
              onClick={toggleTheme}
              className="p-2.5 border border-border rounded text-text-muted hover:text-text-primary hover:border-border-subtle transition-colors"
            >
